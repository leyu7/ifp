...
from ui_help6 import Ui_Help6_Dialog
...
"border-image: url(:/newPrefix/help.png);")
        ...
        self.pushButton_rollDice.setStyleSheet("font: 10pt \"SetoFont\";")
...
"color: rgb(236, 128, 81);")
        ...
        self.pushButton_help.clicked.connect(self.pop_help_window)  # open the help window of 6 discs
        self.pushButton_quit.clicked.connect(QtCore.QCoreApplication.instance().quit)

    def pop_help_window(self):
            self.form = QtWidgets.QWidget()
            self.ui = Ui_Help6_Dialog()
            self.ui.setupUi(self.form)
            self.form.show()

    def retranslateUi(self, Form_6):
        _translate = QtCore.QCoreApplication.translate
        Form_6.setWindowTitle(_translate("Form_6", "PERUKE - 6 Discs Ver."))
