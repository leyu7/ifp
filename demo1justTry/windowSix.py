...
# Form implementation generated from reading ui file 'windowSix.ui'
#
...
class Ui_Six2_Window(object):
    def setupUi(self, Six2_Window):
        Six2_Window.setObjectName("Six2_Window")
        Six2_Window.resize(1128, 841)
        Six2_Window.setMinimumSize(QtCore.QSize(1128, 841))
        Six2_Window.setMaximumSize(QtCore.QSize(1128, 841))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Six2_Window.setWindowIcon(icon)
        Six2_Window.setWindowOpacity(5.0)
        Six2_Window.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(Six2_Window)
        ...
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(10, 70, 1111, 132))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(10, 540, 1111, 132))
        ...
        self.label_timer_icon = QtWidgets.QLabel(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_timer_icon.sizePolicy().hasHeightForWidth())
        self.label_timer_icon.setSizePolicy(sizePolicy)
        self.label_timer_icon.setMinimumSize(QtCore.QSize(40, 40))
        self.label_timer_icon.setMaximumSize(QtCore.QSize(40, 40))
        self.label_timer_icon.setStyleSheet("border-image: url(:/newPrefix/timer.png);")
        self.label_timer_icon.setText("")
        self.label_timer_icon.setObjectName("label_timer_icon")
        self.horizontalLayout_timer.addWidget(self.label_timer_icon)
        self.label_timer_num = QtWidgets.QLabel(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_timer_num.sizePolicy().hasHeightForWidth())
        self.label_timer_num.setSizePolicy(sizePolicy)
        self.label_timer_num.setMinimumSize(QtCore.QSize(40, 40))
        self.label_timer_num.setMaximumSize(QtCore.QSize(40, 40))
        self.label_timer_num.setStyleSheet("font: 15pt \"SetoFont\";")
        self.label_timer_num.setObjectName("label_timer_num")
        self.horizontalLayout_timer.addWidget(self.label_timer_num)
        self.gridLayoutWidget_6 = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget_6.setGeometry(QtCore.QRect(10, 210, 1111, 132))
        ...
        self.gridLayoutWidget_7.setGeometry(QtCore.QRect(10, 680, 1111, 132))
        ...
        self.pushButton_help_6 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_help_6.setGeometry(QtCore.QRect(960, 20, 100, 45))
        self.pushButton_help_6.setMinimumSize(QtCore.QSize(100, 45))
        self.pushButton_help_6.setMaximumSize(QtCore.QSize(100, 45))
        self.pushButton_help_6.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_help_6.setStyleSheet("font: 10pt \"SetoFont\";\n"
"border-image: url(:/newPrefix/help.png);")
        self.pushButton_help_6.setText("")
        self.pushButton_help_6.setObjectName("pushButton_help_6")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(390, 400, 356, 82))
        ...
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(900, 490, 219, 42))
...
"color: rgb(236, 128, 81);")
        ...
        self.horizontalLayoutWidget_6.setGeometry(QtCore.QRect(20, 350, 234, 42))
...
"color: rgb(106, 83, 131);")
        ...
        Six2_Window.setCentralWidget(self.centralwidget)

        self.retranslateUi(Six2_Window)
        QtCore.QMetaObject.connectSlotsByName(Six2_Window)

    def retranslateUi(self, Six2_Window):
        _translate = QtCore.QCoreApplication.translate
        Six2_Window.setWindowTitle(_translate("Six2_Window", "PERUKE"))
        self.label_p12.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#6a5383;\">2</span><span style=\" font-size:12pt; font-weight:600; color:#6a5383; vertical-align:super;\">nd</span></p></body></html>"))
        self.label_p22.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#ec8051;\">2</span><span style=\" font-size:12pt; font-weight:600; color:#ec8051; vertical-align:super;\">nd</span></p></body></html>"))
        self.label_timer_num.setText(_translate("Six2_Window", "<html><head/><body><p><br/></p></body></html>"))
        self.label_p11.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#6a5383;\">1</span><span style=\" font-size:12pt; font-weight:600; color:#6a5383; vertical-align:super;\">st</span></p></body></html>"))
        self.label_p21.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#ec8051;\">1</span><span style=\" font-size:12pt; font-weight:600; color:#ec8051; vertical-align:super;\">st</span></p></body></html>"))
        self.pushButton_rollDice.setText(_translate("Six2_Window", "ROLL"))
        self.label_p2.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-weight:600; color:#ec8051;\">Player2:</span></p></body></html>"))
        self.label_score_2.setText(_translate("Six2_Window", "<html><head/><body><p><br/></p></body></html>"))
        self.label_p1.setText(_translate("Six2_Window", "<html><head/><body><p><span style=\" font-weight:600; color:#6a5383;\">Player1:</span></p></body></html>"))
        self.label_score_1.setText(_translate("Six2_Window", "<html><head/><body><p><br/></p></body></html>"))
