...
# Form implementation generated from reading ui file 'windowInit.ui'
#
...
import background   # https://blog.csdn.net/weixin_45721776/article/details/113566192


class Ui_Init_Window(object):
    def setupUi(self, Init_Window):
        Init_Window.setObjectName("Init_Window")
        Init_Window.resize(1128, 841)
        Init_Window.setMinimumSize(QtCore.QSize(1128, 841))
        Init_Window.setMaximumSize(QtCore.QSize(1128, 841))
        icon = QtGui.QIcon()
        ...
        self.start_pushButton.setGeometry(QtCore.QRect(460, 740, 181, 61))
